...
##        partial_maze.last_visited = partial_maze.start
##        return partial_maze
            ...
            for event in pygame.event.get(): 
                ...
                for grid in self.grids:
                        ...
                        if grid.visited == True and grid.blocked == False:
                            color = BLUE
                        #--
                        if grid.path == True and grid.blocked == False:
                            color = GREEN
                        #--
                        if grid == self.start:
                            color = RED
...
##            prt_exp_grid = partial_maze.get_partial_grid(partial_maze, exp_grid.x, exp_grid.y)
##            prt_exp_grid = exp_grid
...
##            self.run_AStar()
##            done = self.check_probable_path()
##            done = True
##            if last_grid == self.end:
##                done = True
##                break
##            else:
##                self.start =  last_grid
