...
//				// tm.enter(node);
//
//				//				BACKUPsearchResultsList = jQuery.extend(true,{},customerSurveyList);
////				searchByKeyword(
////						document.getElementById('search_keyword').value,
////						document.getElementById('min_score').value, document
////								.getElementById('max_score').value, document
////								.getElementById('datepickerStart').value,
