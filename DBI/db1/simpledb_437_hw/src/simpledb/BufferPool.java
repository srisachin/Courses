...
public class BufferPool {
	...
	//IMPLEMENT THIS
        ...
        if (!_cachedPages.containsKey(pid.hashCode())) {
        	if (_cachedPages.size() >= _numPages) {
            	evictPage();	
            }
        	_nummisses += 1;
    ...
    */
	...
	//IMPLEMENT THIS
    	...
    	{
    			int firstUsed  =_recentlyUsed.removeFirst();
        			_cachedPages.remove(firstUsed);
    				return firstUsed;
