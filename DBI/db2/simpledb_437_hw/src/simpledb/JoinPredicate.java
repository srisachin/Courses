...
public class JoinPredicate {
	...
	//IMPLEMENT THIS
    	Field testedLeftValue =  (IntField)t1.getField(_leftField);
    	Field testedRightValue =  (IntField)t2.getField(_rightField);
//    	System.out.println(((IntField) testedLeftValue).getValue());
//    	System.out.println(((IntField) testedRightValue).getValue());
//    	int testedLeftValue =  ((IntField)t1.getField(_leftField)).getValue();
//    	int testedRightValue =  ((IntField)t2.getField(_rightField)).getValue();
    	return testedLeftValue.compare(_op,testedRightValue);
  //  	System.out.println(testedLeftValue);
  //  	System.out.println(testedRightValue);
  //  	return (testedLeftValue == testedRightValue);
	//return false;
